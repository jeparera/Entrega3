...
class Game():
    ...
    def ganador(self):
        self.jugadores[0].contar_puntos
        self.jugadores[1].contar_puntos
        total_player1 = self.jugadores[0].puntos()
        total_player2 = self.jugadores[1].puntos()
    ...
    def get_info(self):
        info = {
            ...
            'puntos player1': self.jugadores[0].get_points(),
            'puntos player2': self.jugadores[1].get_points(),
            'mesa': self.mesa,
